...
@section('content.header.title', 'Edit Payment')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            wire:model.blur="payment_name" required value="{{ $payment_name }}">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            wire:model.blur="payment_code" value="{{ $payment_code }}">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    @elseif($payment_image_current)
                                        <div class="form-group">
                                            <label for="payment_image">Current Image</label>
                                            <div style="width: 325px;">
                                                <img class="img-fluid" src="{{ $payment_image_current }}">
                                            </div>
                                        </div>
                                    @endif
                                </div>
