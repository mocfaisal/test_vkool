@section('app.title', 'Promo Category - Edit')
@section('content.header.title', 'Promo Category - Edit')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="category_name" placeholder="Category Name" wire:model.blur="category_name" required
                                    value="{{ $category_name }}">
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            ...
                                            name="category_image" placeholder="Image" accept="image/png"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    @elseif($category_image_current)
                                        <div class="form-group">
                                            <label for="category_image">Current Icon</label>
                                            <div style="width: 325px;">
                                                <img class="img-fluid" src="{{ $category_image_current }}">
                                            </div>
                                        </div>
                                    @endif
                                </div>
