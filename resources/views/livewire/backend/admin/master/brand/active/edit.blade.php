                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            ...
                                            name="brand_image" placeholder="Image" accept="image/png"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    @elseif($brand_image_current)
                                        <div class="form-group">
                                            <label for="brand_image">Current Image</label>
                                            <div style="width: 325px;">
                                                <img class="img-fluid" src="{{ $brand_image_current }}">
                                            </div>
                                        </div>
                                    @endif
                                </div>
