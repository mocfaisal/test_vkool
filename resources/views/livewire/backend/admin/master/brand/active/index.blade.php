@section('app.title', 'Brands - Active')
@section('content.header.title', 'Brands')
    ...
    <div class="card">
        <div class="card-header">
            <div class="float-start">
                <h4 class="card-title">Brands Active</h4>
            </div>
            <div class="float-end">
                <div class="buttons">
                    <a class="btn icon icon-left btn-primary" href="{{ route('backend.admin.master.brand.active.create') }}"
...
@section('private.js.code')
    ...
    <script>
        ...
        async function initTableElem() {
            ...
            const txt =
                '<table id="tbl_list" class="table-striped table-hover table table" style="width: 100%;"> <thead> <tr> <th style="vertical-align: middle; text-align: center;" rowspan="2">No.</th> <th style="vertical-align: middle; text-align: center;" rowspan="2">Image</th> <th style="vertical-align: middle; text-align: center;" rowspan="2">Name</th> <th style="vertical-align: middle; text-align: center;" rowspan="2">Code</th> <th style="vertical-align: middle; text-align: center;" colspan="2">Status Display</th> <th style="vertical-align: middle; text-align: center;" rowspan="2">Action</th> </tr> <tr> <th style="vertical-align: middle; text-align: center;">Home</th> <th style="vertical-align: middle; text-align: center;">TOP</th> </tr> </thead> </table>';
            field_table.html(txt);
            return true;
        }

        async function loadData() {
            var tbl_link = "{{ route('backend.admin.master.brand.active.getData.table') }}";
            ...
            table = await $('#tbl_list').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'home_display_status',
                    }, {
                        data: 'top_display_status',
                    },
                    {
                        data: 'action',
                        orderable: false,
