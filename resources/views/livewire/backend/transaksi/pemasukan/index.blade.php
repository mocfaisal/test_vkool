@section('app.title', 'Pemasukan')
@section('content.header.title', 'Pemasukan')
...
<div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-end">
                <div class="buttons">
                    <a class="btn icon icon-left btn-primary" href="{{ route('backend.transaksi.pemasukan.create') }}"
    ...
    <livewire:backend.transaksi.pemasukan.detail>
</div>
...
@section('private.js.code')
    ...
    <script>
        ...
        async function initTableElem() {
            ...
            const txt =
                '<table id="tbl_list" class="table-striped table-hover table table" style="width: 100%;"> <thead> <tr> <th style="vertical-align: middle; text-align: center;">No</th> <th style="vertical-align: middle; text-align: center;">Tanggal</th> <th style="vertical-align: middle; text-align: center;">Judul</th> <th style="vertical-align: middle; text-align: center;">Nominal</th> <th style="vertical-align: middle; text-align: center;">Aksi</th> </tr> </thead> <tbody> <tr> <td style="vertical-align: middle; text-align: center;" colspan="5">Pilih filter lalu tekan tombol cari</td> </tr> </tbody> <tfoot> <tr> <th colspan="3">Total</th> <th colspan="1">&nbsp;</th> <th colspan="1">&nbsp;</th> </tr> </tfoot> </table>';
            field_table.html(txt);
            return true;
        }

        async function loadData() {
            var tbl_link = "{{ route('backend.transaksi.pemasukan.getData.table') }}";
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            var myModalEl = document.querySelector('#mdl_detail')
