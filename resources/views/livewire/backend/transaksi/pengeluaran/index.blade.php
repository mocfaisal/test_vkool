...
<div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-end">
                <div class="buttons">
                    <a class="btn icon icon-left btn-primary" href="{{ route('backend.transaksi.pengeluaran.create') }}"
    ...
    <livewire:backend.transaksi.pengeluaran.detail>
...
@section('private.js.code')
    ...
    <script>
        ...
        async function loadData() {
            var tbl_link = "{{ route('backend.transaksi.pengeluaran.getData.table') }}";
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            ...
            @this.on('showResult', (response) => {
                ...
                var myModalEl = document.querySelector('#mdl_pengeluaran')
            ...
            // var mymodal = document.getElementById('mdl_pengeluaran')
