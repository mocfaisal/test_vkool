<div class="modal fade text-left" id="mdl_saving" data-bs-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="mdl_saving_label" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="mdl_saving_label">
                    @if ($is_edit)
                        Edit
                    @else
                        Tambah
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nama Tabungan"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" placeholder="Jangka Waktu" min="1"
                                        max="10" wire:model="input_jangka_waktu" value="1"
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label>Nominal Simulasi (Perbulan)</label>
                                <input type="text" class="form-control mask-nominal"
                                    placeholder="Nominal Simulasi (Perbulan)" wire:model="input_nominal_simulasi">
