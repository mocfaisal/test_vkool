<div class="modal fade text-left" id="mdl_saving_pop_detail" data-bs-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="mdl_saving_pop_detail_label" aria-hidden="true" wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="mdl_saving_pop_detail_label">
                    Detail Tabungan - {{ $title_saving }}
                </h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 row d-flex justify-content-between">
                            ...
                            <div class="col-3">
                                <a title="Lihat Detail Tabungan"
                                    href="{{ route('backend.transaksi.savings.detail', ['id_saving' => $id]) }}"
...
@push('scripts')
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            var myModalEl = document.querySelector('#mdl_saving_pop_detail')
            var modal = bootstrap.Modal.getOrCreateInstance(myModalEl)

            // Listen to dispatch from server
            @this.on('popSaving_detail_modal', (res) => {
                modal.show();
                // console.log(res);
