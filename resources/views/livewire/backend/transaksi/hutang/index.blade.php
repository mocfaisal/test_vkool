@section('app.title', 'Hutang')
@section('content.header.title', 'Hutang')
...
<div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="float-start">
                <h4 class="card-title">List Data Hutang</h4>
            </div>
            <div class="float-end">
                <div class="buttons">
                    <a class="btn icon icon-left btn-primary" data-bs-toggle="modal" data-bs-target="#mdl_hutang"><i
                        ...
                        <div class="col-xl-4 col-md-6 col-sm-12" wire:key="{{ $data->id }}">
                            <div class="card bordered border-success">
                                <div class="card-content"
                                    wire:click="$dispatch('popHutang', {id_hutang: {{ $data->id }}})">
                                    <div class="card-body">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <div class="btn-group">
                                        <button class="btn icon btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#mdl_hutang" title="Edit"
                                        ...
                                        <button class="btn btn-light-primary" data-bs-toggle="modal"
                                            data-bs-target="#mdl_hutang_pop_detail" title="Detail"
    ...
    <livewire:backend.transaksi.hutang.create>
        <livewire:backend.transaksi.hutang.pop-add>
            <livewire:backend.transaksi.hutang.pop-detail>
