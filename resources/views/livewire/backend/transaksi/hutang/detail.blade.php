@section('app.title', 'List Data Transaksi Hutang' . $nm_hutang)
...
<div>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-1">
                    <a class="btn icon icon-left btn-warning" href="{{ route('backend.transaksi.hutang') }}"
                        wire:navigate><i class="bi bi-arrow-left"></i></a>
                </div>
                <div class="col">
                    <h4 class="card-title">Hutang {{ $nm_hutang }}</h4>
...
@section('private.js.code')
    ...
    <script>
        ...
        async function loadData() {
            var tbl_link = "{{ route('backend.transaksi.hutang.detail.getData.table', ['id_hutang' => $id_hutang]) }}";
    ...
    <script>
        ...
        document.addEventListener('livewire:navigated', () => {
            ...
            Livewire.on('showResult2', (response) => popResult2(response));
        });
