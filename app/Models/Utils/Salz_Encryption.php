...
class Salz_Encryption {

    // NOTE copied form Codeigniter 3 Encryption
    protected $encryption_key = 'mms-encryption-key';
	...
	public function __construct(array $params = array())
	{
		...
		if ( ! isset($this->_key) && self::strlen($key = $this->encryption_key) > 0)
		{
			$this->_key = $key;
		}
