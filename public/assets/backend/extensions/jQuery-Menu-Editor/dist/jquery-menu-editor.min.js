function MenuEditor(e,t){var s=$("#"+e).data("level","0"),l={labelEdit:'<i class="fas fa-edit clickable"></i>',labelRemove:'<i class="fas fa-trash-alt clickable"></i>',textConfirmDelete:"This item will be deleted. Are you sure?",iconPicker:{cols:4,rows:4,footer:!1,iconset:"fontawesome5"},maxLevel:-1,autoResetForm:["add","edit"],listOptions:{hintCss:{border:"1px dashed #13981D"},opener:{as:"html",close:'<i class="fas fa-minus"></i>',open:'<i class="fas fa-plus"></i>',openerCss:{"margin-right":"10px",float:"none"},openerClass:"btn btn-success btn-sm"},placeholderCss:{"background-color":"gray"},ignoreClass:"clickable",listsClass:"pl-0",listsCss:{"padding-top":"10px"},complete:function(e){return MenuEditor.updateButtons(s),s.updateLevels(0),!0},isAllowed:function(e,t,s){return v(e,s)}}};$.extend(!0,l,t);var n=null,o=!0,i=null,r=null,a=l.iconPicker,c=(t=l.listOptions,$("#"+e+"_icon").iconpicker(a));function d(){i[0].reset(),c.iconpicker("setIcon","empty"),r.attr("disabled",!0),n=null}function p(e){return $("<a>").addClass(e.classCss).addClass("clickable").attr("href","#").html(e.text)}function u(){var e=$("<div>").addClass("btn-group float-end"),t=p({classCss:"btn btn-primary btn-sm btnEdit",text:l.labelEdit}),s=p({classCss:"btn btn-danger btn-sm btnRemove",text:l.labelRemove}),n=p({classCss:"btn btn-secondary btn-sm btnUp btnMove",text:'<i class="fas fa-angle-up clickable"></i>'}),o=p({classCss:"btn btn-secondary btn-sm btnDown btnMove",text:'<i class="fas fa-angle-down clickable"></i>'}),i=p({classCss:"btn btn-secondary btn-sm btnOut btnMove",text:'<i class="fas fa-level-down-alt clickable"></i>'}),r=p({classCss:"btn btn-secondary btn-sm btnIn btnMove",text:'<i class="fas fa-level-up-alt clickable"></i>'});return e.append(n).append(o).append(r).append(i).append(t).append(s),e}function f(e,t){var l=void 0===t?0:t,n=0===l?s:$("<ul>").addClass("pl-0").css("padding-top","10px").data("level",l);return $.each(e,(function(e,t){var s=void 0!==t.children&&$.isArray(t.children),o={text:"",href:"",icon:"empty",target:"_self",title:""},i=$.extend({},t);s&&delete i.children,$.extend(o,i);var r=$("<li>").addClass("list-group-item pr-0");r.data(o);var a=$("<div>").css("overflow","auto"),c=$("<i>").addClass(t.icon),d=$("<span>").addClass("txt").append(t.text).css("margin-right","5px"),p=u();a.append(c).append("&nbsp;").append(d).append(p),r.append(a),s&&r.append(f(t.children,l+1)),n.append(r)})),n}function h(e){var s=$("<span>").addClass("sortableListsOpener "+t.opener.openerClass).css(t.opener.openerCss).on("mousedown touchstart",(function(e){var s=$(this).closest("li");return s.hasClass("sortableListsClosed")?s.iconOpen(t):s.iconClose(t),!1}));s.prependTo(e.children("div").first()),e.hasClass("sortableListsOpen")?e.iconOpen(t):e.iconClose(t)}function v(e,t){if(l.maxLevel<0)return!0;var s=0,n=e.find("ul").length;return s=0==t.length?0:parseInt(t.parent().data("level"))+1,console.log(s+n),s+n<=l.maxLevel}s.sortableLists(l.listOptions),c.on("change",(function(e){i.find("[name=icon]").val(e.icon)})),s.on("click",".btnRemove",(function(t){if(t.preventDefault(),confirm(l.textConfirmDelete)){var n=$(this).closest("ul");$(this).closest("li").remove();var o=!1;void 0!==n.attr("id")&&(o=n.attr("id").toString()===e),n.children().length||o||(n.prev("div").children(".sortableListsOpener").first().remove(),n.remove()),MenuEditor.updateButtons(s)}})),s.on("click",".btnEdit",(function(e){e.preventDefault(),function(e){var t=e.data();$.each(t,(function(e,t){i.find("[name="+e+"]").val(t)})),i.find(".item-menu").first().focus(),t.hasOwnProperty("icon")?c.iconpicker("setIcon",t.icon):c.iconpicker("setIcon","empty");r.removeAttr("disabled")}(n=$(this).closest("li"))})),s.on("click",".btnUp",(function(e){e.preventDefault();var t=$(this).closest("li");t.prev("li").before(t),MenuEditor.updateButtons(s)})),s.on("click",".btnDown",(function(e){e.preventDefault();var t=$(this).closest("li");t.next("li").after(t),MenuEditor.updateButtons(s)})),s.on("click",".btnOut",(function(e){e.preventDefault();var t=$(this).closest("ul"),l=$(this).closest("li");l.closest("ul").closest("li").after(l),t.children().length<=0&&(t.prev("div").children(".sortableListsOpener").first().remove(),t.remove()),MenuEditor.updateButtons(s),s.updateLevels()})),s.on("click",".btnIn",(function(e){e.preventDefault();var t=$(this).closest("li"),l=t.prev("li");if(!v(t,l))return!1;if(l.length>0)if((n=l.children("ul")).length>0)n.append(t);else{var n=$("<ul>").addClass("pl-0").css("padding-top","10px");l.append(n),n.append(t),l.addClass("sortableListsOpen"),h(l)}MenuEditor.updateButtons(s),s.updateLevels()})),this.setForm=function(e){i=e},this.getForm=function(){return i},this.setUpdateButton=function(e){(r=e).attr("disabled",!0),n=null},this.getUpdateButton=function(){return r},this.getCurrentItem=function(){return n},this.update=function(){var e=this.getCurrentItem();if(null!==e){var t=e.data("icon");i.find(".item-menu").each((function(){e.data($(this).attr("name"),$(this).val())})),e.children().children("i").removeClass(t).addClass(e.data("icon")),e.find("span.txt").first().text(e.data("text")),-1!==$.inArray("edit",l.autoResetForm)&&d()}},this.add=function(){var e={};i.find(".item-menu").each((function(){e[$(this).attr("name")]=$(this).val()}));var t=u(),n=$("<span>").addClass("txt").text(e.text),o=$("<i>").addClass(e.icon),r=$("<div>").css({overflow:"auto"}).append(o).append("&nbsp;").append(n).append(t),a=$("<li>").data(e);a.addClass("list-group-item pr-0").append(r),s.append(a),MenuEditor.updateButtons(s),-1!==$.inArray("add",l.autoResetForm)&&d()},this.getString=function(){var e=s.sortableListsToJson();return JSON.stringify(e)},this.setData=function(e){var t=Array.isArray(e)?e:function(e){try{var t=JSON.parse(e)}catch(e){return console.log("The string is not a json valid."),null}return t}(e);if(null!==t){s.empty();var n=f(t);o?s.find("li").each((function(){var e=$(this);e.children("ul").length&&h(e)})):(n.sortableLists(l.listOptions),o=!0),MenuEditor.updateButtons(s)}}}!function(e){
/**
